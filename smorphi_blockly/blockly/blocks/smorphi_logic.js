...
goog.provide('Blockly.Blocks.smorphi_logic');
...
Blockly.Blocks.smorphi_logic.HUE = 210;
...
Blockly.Blocks['controls_if'] = {
  ...
  init: function() {
    ...
    this.setColour(Blockly.Blocks.smorphi_logic.HUE);
...
Blockly.Blocks['logic_compare'] = {
  ...
  init: function() {
    ...
    //this.setHelpUrl(Blockly.Msg.smorphi_logic_COMPARE_HELPURL);
    this.setColour(Blockly.Blocks.smorphi_logic.HUE);
...
Blockly.Blocks['logic_negate'] = {
  ...
  init: function() {
    this.jsonInit({
      ...
      "colour": Blockly.Blocks.smorphi_logic.HUE,
...
Blockly.Blocks['robot_shape'] = {
  init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldDropdown([["I_shape", "'i'"], ["O_shape", "'o'"], ["L_shape", "'l'"], ["J_shape", "'j'"], ["T_shape", "'t'"], ["Z_shape", "'z'"], ["S_shape", "'s'"]]), "NAME");
...
Blockly.Blocks['color_state'] = {
  init: function() {
    this.appendDummyInput()
       // .appendField(new Blockly.FieldTextInput('0', Blockly.FieldTextInput.numberValidator),'NUM');
        .appendField(new Blockly.FieldDropdown([["RED", '1', Blockly.FieldTextInput.numberValidator], ["YELLOW", "2", Blockly.FieldTextInput.numberValidator], ["GREEN", "3", Blockly.FieldTextInput.numberValidator]]), "NUM");
    this.setOutput(true, null);
    this.setColour(20);
    this.setTooltip('');
    this.setHelpUrl('http://www.example.com/');
