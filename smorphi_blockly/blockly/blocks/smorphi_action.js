...
Blockly.Blocks['stop'] = {
  init: function() {
    this.appendValueInput()
        .appendField(new Blockly.FieldDropdown([["stopSmorphi_single", "stopSmorphi_single"], ["stopSmorphi", "stopSmorphi"],]), "NAME");
    this.setPreviousStatement(true, "String");
    this.setNextStatement(true, "String");
    this.setColour(20);
    this.setTooltip('');
...
Blockly.Blocks['RGB_color'] = {
  init: function() {
    this.appendValueInput()
        .appendField(new Blockly.FieldDropdown([["red", "digitalWrite(25, HIGH);\ndigitalWrite(26, LOW);\ndigitalWrite(27, LOW);\n"], ["green", "digitalWrite(25, LOW);\ndigitalWrite(26, HIGH);\ndigitalWrite(27, LOW);\n"], ["blue", "digitalWrite(25, LOW);\ndigitalWrite(26, LOW);\ndigitalWrite(27, HIGH);"], ["white", "digitalWrite(25, HIGH);\ndigitalWrite(26, HIGH);\ndigitalWrite(27, HIGH);"],["off", "digitalWrite(25, LOW);\ndigitalWrite(26, LOW);\ndigitalWrite(27, LOW);"]]), "NAME");
    this.setPreviousStatement(true, "String");
    this.setNextStatement(true, "String");
    this.setColour(20);
    this.setTooltip('');
