...
goog.locale.genericFontNamesData = {
  'Arab': [
    ['sans-serif', 'Arial,Al Bayan'],
    ['serif', 'Arabic Typesetting,Times New Roman']
  ],
  ...
  'Deva': [
    ['sans-serif', 'Mangal,Lohit Hindi'],
    ['serif', 'Arial Unicode MS,Devanagari']
  ],
  'Ethi': [['serif', 'Nyala']],
  'Geor': [['serif', 'Sylfaen']],
  ...
  'Hebr': [
    ['sans-serif', 'Gisha,Aharoni,Arial Hebrew'], ['serif', 'David'],
    ['monospace', 'Miriam Fixed']
  ],
  ...
  'root': [
    ['sans-serif', 'FreeSans'], ['serif', 'FreeSerif'],
    ['monospace', 'FreeMono']
  ],
  'transpose': {
    'zh': {
